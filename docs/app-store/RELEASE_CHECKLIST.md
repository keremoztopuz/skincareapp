...
- [ ] App Store Connect subscription urunu hazir. `com.keremoztopuz.skincare.pro.weekly` (26 Agustos'ta acildi, ONE_WEEK), `...pro.monthly` (artik hicbir pakete bagli degil) ve `...pro.lifetime` `READY_TO_SUBMIT`. **Acik is:** weekly urun RevenueCat'te `skanner_pro` entitlement'ina elle baglanmali, yoksa satin alma hicbir kilidi acmaz: tum bolgelerde fiyat, en-US + tr yerellestirme, review ekran goruntusu ve notu girili. Ilk build ile birlikte incelemeye gidecekler.
